/**
 * AI Processing Summary Component
 *
 * NOTE: Convex API calls temporarily disabled to avoid TypeScript deep instantiation issues
 * during development. Component will be fully functional once Convex functions are deployed.
 */
...
export function AIProcessingSummary({ userId }: AIProcessingSummaryProps) {
  // Temporary null values to avoid deep type instantiation issues during development
  const activeProcessing = null // useQuery(api.aiAnalysis.getUserActiveProcessing, { userId })
  const processingStats = null // useQuery(api.aiAnalysis.getProcessingStats, { userId })
  const retryAnalysis = null // useMutation(api.scheduler.requeueAnalysis)
  ...
  // Return placeholder during development when API calls are disabled
