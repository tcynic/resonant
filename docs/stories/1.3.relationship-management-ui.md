...
- [ ] **REL-001**: Design and implement relationship creation form component (AC: 1, 2, 3)
  - [ ] Create `RelationshipForm.tsx` component with form fields
  - [ ] Add name input with proper validation
  - [ ] Implement relationship type selector dropdown
  - [ ] Add optional photo upload functionality
  - [ ] Implement form validation and error handling
  - [ ] Add success/confirmation messaging
- [ ] **REL-002**: Create relationship type selector component (AC: 2)
  - [ ] Build dropdown/select component for relationship types
  - [ ] Ensure types match Convex schema definitions
  - [ ] Add proper styling and accessibility
- [ ] **REL-003**: Implement photo upload functionality (AC: 3)
  - [ ] Add file input for relationship photos
  - [ ] Implement image preview functionality
  - [ ] Add image validation (size, format)
  - [ ] Handle photo storage (placeholder for now)

### Relationship Management Interface (AC: 4, 5, 6, 7, 8, 9)

- [ ] **REL-004**: Create relationships list view component (AC: 4, 9)
  - [ ] Build `RelationshipsList.tsx` component
  - [ ] Implement responsive grid/list layout
  - [ ] Add search functionality for filtering relationships
  - [ ] Add filter by relationship type
  - [ ] Implement pagination for large lists
- [ ] **REL-005**: Design relationship card/item component (AC: 4)
  - [ ] Create `RelationshipCard.tsx` component
  - [ ] Display relationship name, type, and photo
  - [ ] Add action buttons (edit, delete)
  - [ ] Implement card hover states and interactions
- [ ] **REL-006**: Implement edit relationship functionality (AC: 5, 7)
  - [ ] Add edit mode to relationship form
  - [ ] Pre-populate form with existing data
  - [ ] Implement update operation with Convex
  - [ ] Add update confirmation messaging
- [ ] **REL-007**: Add delete relationship functionality (AC: 6, 7)
  - [ ] Implement delete confirmation dialog
  - [ ] Add delete operation with Convex
  - [ ] Handle delete success and error states
  - [ ] Prevent deletion if relationship has journal entries
- [ ] **REL-008**: Create empty state for no relationships (AC: 8)
  - [ ] Design empty state component
  - [ ] Add call-to-action to create first relationship
  - [ ] Include helpful messaging and illustrations

### User Onboarding Flow (AC: 10)

- [ ] **ONB-001**: Design welcome/onboarding screen (AC: 10)
  - [ ] Create welcome screen for new users
  - [ ] Add guided tour for relationship creation
  - [ ] Implement onboarding progress indicators
- [ ] **ONB-002**: Create "Add Your First Relationship" flow (AC: 10)
  - [ ] Build streamlined first relationship flow
  - [ ] Add helpful tips and guidance
  - [ ] Implement skip/complete onboarding options

### Integration and Navigation (AC: 11)

- [ ] **NAV-001**: Create relationships page and routing (AC: 11)
  - [ ] Set up `/relationships` page route
  - [ ] Add relationships navigation to main layout
  - [ ] Implement responsive mobile navigation
- [ ] **INT-001**: Integrate with existing Convex backend (AC: 1-7)
  - [ ] Connect components to existing Convex relationship functions
  - [ ] Implement real-time updates for relationship changes
