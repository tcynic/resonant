...
- [ ] **JRN-017**: Implement comprehensive test suite for journal components
  ...
  - [ ] Create test for `tag-input.tsx` component
  - [ ] Create test for `relationship-picker.tsx` component
  - [x] Create test for `use-journal-entries.ts` hook
  - [x] Create test for `use-auto-save.ts` hook
- [ ] **JRN-018**: Fix code quality issues identified in QA review
  - [ ] Fix ESLint apostrophe escaping warnings
