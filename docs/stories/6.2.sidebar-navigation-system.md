...
- [ ] **SIDEBAR-001**: Create AppSidebar component foundation (AC: 1, 2, 3)
  - [ ] Create `src/components/layout/AppSidebar.tsx` component
  - [ ] Integrate with existing `NavigationProvider` context from Story 6.0
  - [ ] Implement collapsible functionality with expand/collapse toggle
  - [ ] Add primary navigation items (Dashboard, Journal, Relationships, Insights, Search)
  - [ ] Add secondary navigation items (Settings, Profile, Help/Support)
  - [ ] Use proper semantic HTML structure with navigation landmarks
  - [ ] Add ARIA labels and accessibility support

### Navigation State Management

- [ ] **SIDEBAR-002**: Implement sidebar state management (AC: 1, 6)
  - [ ] Connect to NavigationProvider's `sidebarCollapsed` state
  - [ ] Implement toggle functionality using navigation actions
  - [ ] Add localStorage persistence for collapsed/expanded preference
  - [ ] Handle responsive behavior with proper breakpoint management
  - [ ] Add smooth animation transitions for expand/collapse

### Active Route Highlighting

- [ ] **SIDEBAR-003**: Implement current page indication (AC: 5)
  - [ ] Use NavigationProvider's `currentRoute` state for active highlighting
  - [ ] Add visual indicators for active navigation items
  - [ ] Implement proper CSS classes for active/inactive states
  - [ ] Update active state on route changes using Next.js router
  - [ ] Add hover states and focus management for accessibility

### Quick Actions Implementation

- [ ] **SIDEBAR-004**: Add quick action buttons (AC: 4)
  - [ ] Create "New Journal Entry" quick action button
  - [ ] Create "Add Relationship" quick action button
  - [ ] Create "View Latest Insights" quick action link
  - [ ] Create "Search Everything" quick access input
  - [ ] Position quick actions prominently in sidebar
  - [ ] Add proper icons and tooltips for each action

### Recent Items Integration

- [ ] **SIDEBAR-005**: Implement recent items section (AC: 7)
  - [ ] Connect to NavigationProvider's `recentItems` state
  - [ ] Display last viewed journal entries with titles and timestamps
  - [ ] Display recently accessed relationships with names and photos
  - [ ] Add proper truncation for long titles
  - [ ] Implement click-to-navigate functionality for recent items
  - [ ] Add "View All" link for complete history

### AppShell Integration

- [ ] **SIDEBAR-006**: Integrate AppSidebar into AppShell layout
  - [ ] Update `src/components/layout/AppShell.tsx` to include AppSidebar
  - [ ] Replace placeholder sidebar with actual AppSidebar component
  - [ ] Ensure proper layout coordination with AppNavBar
  - [ ] Implement responsive layout behavior
  - [ ] Test integration with all existing pages

### Responsive Design Implementation

- [ ] **SIDEBAR-007**: Implement responsive sidebar behavior
  - [ ] Auto-collapse sidebar on mobile viewports (< 768px)
  - [ ] Add overlay behavior for mobile sidebar
  - [ ] Implement swipe gestures for mobile open/close
  - [ ] Add proper z-index layering for mobile overlay
  - [ ] Test touch interactions and gesture support

### Testing Implementation

- [ ] **SIDEBAR-008**: Comprehensive sidebar testing
  - [ ] Create `src/components/layout/__tests__/AppSidebar.test.tsx`
  - [ ] Test sidebar collapse/expand functionality
  - [ ] Test navigation item clicks and routing
  - [ ] Test active route highlighting accuracy
  - [ ] Test quick actions functionality
  - [ ] Test recent items display and navigation
  - [ ] Test responsive behavior and mobile overlay
