...
if (!convexUrl && typeof window !== 'undefined') {
  console.log(
    '❌ Would throw runtime error (but window is undefined in Node.js)'
  )
} else if (!convexUrl) {
  console.log('⚠️  No Convex URL found - would use placeholder during build')
  console.log(
    '   This means the environment variable is NOT available at build time'
  )
} else {
...
if (!convexUrl) {
  ...
  console.log(
    '3. 🔄 Ensure NEXT_PUBLIC_CONVEX_URL is set for "Production" environment'
  )
