...
export async function runMCPTests() {
  ...
  await runTest('Authentication: Sign in with test user', async () => {
    ...
    await mcp__playwright__browser_navigate({ url: `${config.baseURL}/sign-in` })
  ...
  await runTest('Dashboard: View active user data', async () => {
    ...
    await mcp__playwright__browser_navigate({ url: `${config.baseURL}/dashboard` })
  ...
  await runTest('Journal: Create new entry', async () => {
    ...
    await mcp__playwright__browser_navigate({ url: `${config.baseURL}/journal/new` })
  ...
  await runTest('Relationships: View and navigate', async () => {
    ...
    await mcp__playwright__browser_navigate({ url: `${config.baseURL}/relationships` })
